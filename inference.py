...
def inference_three_step(model_dir, tokenized_sent, device, args, is_roberta=False, ):
...
def main(args):
    ...
    if args.model_type and args.k_fold==0:
        ...
        pred_answer, output_prob = inference_three_step_ensemble(model_dir, Re_test_dataset, device, args, is_roberta)
        pred_answer = num_to_label(pred_answer)
